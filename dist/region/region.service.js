...
let RegionService = class RegionService {
    ...
    async findAllRegions() {
        const regions = await this.regionRepository.findAllRegions();
        return region_dto_1.RegionListDto.from(regions);
    }
};
exports.RegionService = RegionService;
exports.RegionService = RegionService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [region_repository_1.RegionRepository])
], RegionService);
